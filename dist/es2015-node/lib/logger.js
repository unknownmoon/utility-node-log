...
const C = new Map([['highlight', fnFilterByColour(_chalk2.default.cyan)], ['time', fnFilterByColour(_chalk2.default.gray)], ['info', fnFilterByColour(_chalk2.default.reset)], ['warn', fnFilterByColour(_chalk2.default.yellow)], ['error', fnFilterByColour(_chalk2.default.red)], ['debug', fnFilterByColour(_chalk2.default.blue)], ['help', fnFilterByColour(_chalk2.default.green)]]);

let _logLevel = new Map(_constants.defaultLogLevels);
let _timeFormat = _constants.OUT_TIME_FMT;
...
class Logger {
  ...
  set logLevel(lvl) {
    ...
    _logLevel = (0, _constants.genLogLevel)(logLvl => logLvl === lvl);
  }
  ...
  inspect(object) {
    ...
    this.debug(`\n${ (0, _util.inspect)(object, {
      depth: 7,
      colors: _constants.IS_COLOURED && true
    }) }\n`);
  }
  ...
  info(...args) {
    ...
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('info')('INFO') }] ${ C.get('info')(args[0]) }`;
  ...
  log(...args) {
    ...
    // override the message
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('debug')('LOG') }] ${ C.get('debug')(args[0]) }`;
  ...
  warn(...args) {
    ...
    // override the message
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('warn')('WARN') }] ${ C.get('warn')(args[0]) }`;
  ...
  error(...args) {
    ...
    // override the message
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('error')('ERROR') }] ${ C.get('error')(args[0]) }`;
  ...
  debug(...args) {
    ...
    // override the message
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('debug')('DEBUG') }] ${ C.get('debug')(args[0]) }`;
  ...
  verbose(...args) {
    ...
    // override the message
    args[0] = `[${ C.get('time')((0, _moment2.default)().format(this.timeFormat)) }][${ C.get('debug')('VERBOSE') }] ${ C.get('debug')(args[0]) }`;
