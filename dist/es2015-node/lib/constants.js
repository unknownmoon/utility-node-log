...
exports.INFO = exports.LOG = exports.WARN = exports.ERROR = exports.DEBUG = exports.VERBOSE = exports.MUTE = exports.OUT_TIME_FMT = exports.defaultLogLevels = exports.IS_COLOURED = undefined;
exports.genLogLevel = genLogLevel;

var _chalk = require('chalk');

var _chalk2 = _interopRequireDefault(_chalk);

var _utilityNodeOptsParser = require('utility-node-opts-parser');
 ...
 * @module constants
 */
const IS_COLOURED = exports.IS_COLOURED = _chalk2.default.supportsColor;
...
const opts = (0, _utilityNodeOptsParser.getOpts)(...LOG_LEVELS.map(level => PREFIX + level).concat(`${ PREFIX }TIME_FMT`));
 ...
 */
function genLogLevel(logLvlValFn) {
...
const defaultLogLevels = exports.defaultLogLevels = genLogLevel(logLvl => _genericEnableStatus(opts, `${ PREFIX }${ logLvl }`));
 ...
 * @type {String}
 */
const OUT_TIME_FMT = exports.OUT_TIME_FMT = opts.get(`${ PREFIX }TIME_FMT`) || 'HH.mm.ss.SSS';
 ...
 * @type {Boolean}
 */
const MUTE = exports.MUTE = defaultLogLevels.get('MUTE');
 ...
 * @type {Boolean}
 */
const VERBOSE = exports.VERBOSE = defaultLogLevels.get('VERBOSE');
 ...
 * @type {Boolean}
 */
const DEBUG = exports.DEBUG = defaultLogLevels.get('DEBUG');
 ...
 * @type {Boolean}
 */
const ERROR = exports.ERROR = defaultLogLevels.get('ERROR');
 ...
 * @type {Boolean}
 */
const WARN = exports.WARN = defaultLogLevels.get('WARN');
 ...
 * @type {Boolean}
 */
const LOG = exports.LOG = defaultLogLevels.get('LOG');
 ...
 * @type {Boolean}
 */
const INFO = exports.INFO = defaultLogLevels.get('INFO');
